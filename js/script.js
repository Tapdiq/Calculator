...
var herfer = document.getElementsByClassName("herfer");
for(var i = 0;i<herfer.length;i++){
    herfer[i].addEventListener('click',function(){
        if(this.id=="temizsilir"){
            printdiv1("");
            printdiv2("");
        }
        else if(this.id=="birbirsilir"){
